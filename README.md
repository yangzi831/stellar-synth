...
- 150 BPM Web Audio engine derived from D5, now layering the original plucks with bounded melodic-techno arpeggios, pads, electronic bass, drums and glitch textures. Percussion and glitch one-shots are procedurally generated sample buffers; no external sample pack or recording is bundled.
