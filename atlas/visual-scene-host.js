...
const SCENE_PROFILES = Object.freeze({
  ...
  'constellation-weave': { atlas: .94, focus: 1, atlasFilter: 'brightness(1.12) saturate(.88) contrast(1.04)', focusFilter: 'brightness(1.04) saturate(.94) contrast(1.03)', params: { particleCount: 56000, audioSensitivity: .94, glowStrength: 1.06 }, atlasParams: { audioSensitivity: 1.08, glowStrength: 1.16, rotationSpeed: .010 }, focusParams: { audioSensitivity: 1.42, glowStrength: 1.34, rotationSpeed: .018, lineOpacity: [.11, .50], pointerInfluence: 1.28 } },
  ...
  'audio-reactive-star-chart': { atlas: .90, focus: .96, atlasFilter: 'brightness(1.08) saturate(.90) contrast(1.02)', focusFilter: 'brightness(.98)', atlasParams: { weights: { nebula: .7, chart: 1, core: 1 }, parallax: .11, audioSmoothing: .08, coreGlow: .22 }, focusParams: { weights: { nebula: .92, chart: 1.18, core: 1.24 }, parallax: .18, audioSmoothing: .12, coreGlow: .38 } },
  ...
  'concentric-field': { atlas: 1, focus: 1, atlasFilter: 'brightness(1.24) saturate(.94) contrast(1.04)', focusFilter: 'brightness(1.10) saturate(1) contrast(1.03)', params: { density: .88, energy: .70, colorMix: .42, interactionGain: 1.10, rotationSpeed: 1.08 }, atlasParams: { density: .98, energy: .84, colorMix: .45, interactionGain: 1.42, rotationSpeed: 1.30 }, focusParams: { density: 1, energy: 1.04, colorMix: .49, interactionGain: 2.06, rotationSpeed: 1.74 } },
});
